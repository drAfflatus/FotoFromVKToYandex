...
class YaApiClient:
    ...
    def check_create_folder(self,name_folder):
        ...
        match response.status_code:
            ...
            case 423:
                result = ['Технические работы. Сейчас можно только просматривать'
                          ' и скачивать файлы (ЯДиск)',False]
            case 406:
                result = ['Ресурс не может быть представлен в запрошенном формате.'
                          +'(ЯДиск)',False]
            case 403:
                result = ['API недоступно. Ваши файлы занимают больше места, чем у вас есть.'
